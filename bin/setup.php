...
$replacements = [
    ...
    'composer create-project otaku/application <project-name>' => 'composer require ' . $projectName,
    'To create a new Application Repository using this template:' => 'Install the package via composer:',
];
